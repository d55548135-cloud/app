...
const ICONS = {
  ...
  donutBadge: `
    <svg class="donut-svg"
      ...
      <!-- ✅ icing with hole (evenodd) -->
      <path fill="#F2498A" fill-rule="evenodd" clip-rule="evenodd"
        d="M425.6,307.2c1.6-1.6,4-3.2,5.6-4.8c16-10.4,26.4-28,26.4-48c0-7.2-1.6-13.6-4-20
        ...
        <!-- HOLE CUTOUT -->
        M242.4,156.8
        c47.2,0,85.6,38.4,85.6,85.6
        c0,47.2-38.4,85.6-85.6,85.6
        c-47.2,0-85.6-38.4-85.6-85.6
        c0-47.2,38.4-85.6,85.6-85.6
        z" />

      <!-- ✅ bigger sprinkles (visible at 18×18) -->
      <circle fill="#FFCE00" cx="322.4" cy="108" r="14"/>
      <circle fill="#FFCE00" cx="368" cy="337.6" r="14"/>
      <circle fill="#91EDEA" cx="241.6" cy="344.8" r="13"/>
      <circle fill="#EFD27F" cx="375.2" cy="172.8" r="12"/>
      <circle fill="#FFCE00" cx="84" cy="236.8" r="12"/>
      <circle fill="#91EDEA" cx="326.4" cy="177.6" r="11"/>
      <circle fill="#EFD27F" cx="246.4" cy="80.8" r="11"/>
    </svg>
  `,
