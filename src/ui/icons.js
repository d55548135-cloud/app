...
const ICONS = {
  ...
  `,
  donutBadge: `
    <svg viewBox="0 0 484.8 484.8" width="18" height="18" aria-hidden="true" focusable="false">
      <!-- base donut -->
      ...
      <path fill="#F2498A" d="M425.6,307.2c1.6-1.6,4-3.2,5.6-4.8c16-10.4,26.4-28,26.4-48c0-7.2-1.6-13.6-4-20
        ...
        c26.4-4.8,47.2-28,47.2-56C427.2,316.8,426.4,312,425.6,307.2z M242.4,328c-47.2,0-85.6-38.4-85.6-85.6
        s38.4-85.6,85.6-85.6s85.6,38.4,85.6,85.6S289.6,328,242.4,328z"/>
    </svg>
  `,
