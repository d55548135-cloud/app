...
const ICONS = {
  ...
  donutBadge: `
    ...
    <g>
        ...
        <ellipse transform="matrix(-0.6224 -0.7827 0.7827 -0.6224 230.1635 219.702)" style="fill:#FFA1C7;" cx="168.078" cy="54.332" rx="8" ry="24.8"/>

        <ellipse transform="matrix(-0.9143 -0.4051 0.4051 -0.9143 15.6562 372.3659)" style="fill:#FFA1C7;" cx="47.227" cy="184.526" rx="7.2" ry="22.401"/>
      ...
      <path style="fill:#FFA1C7;" d="M100,385.6c2.4-3.2,12.8,0.8,23.2,8.8c10.4,8,16,17.6,13.6,20.8c-2.4,3.2-12.8-0.8-23.2-8.8
        ...
        <ellipse transform="matrix(-0.9436 0.331 -0.331 -0.9436 164.0391 429.222)" style="fill:#FFA1C7;" cx="45.47" cy="228.579" rx="4" ry="12.8"/>
    </g>
