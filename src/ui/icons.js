...
const ICONS = {
  ...
  donutBadge: `
    <svg class="donut-svg"
      ...
      <!-- ✅ sprinkles (крупные, чтобы видно на 18×18) -->
      <circle fill="#FFCE00" cx="368" cy="337.6" r="10"/>
      <circle fill="#FFCE00" cx="322.4" cy="108" r="10"/>
      <circle fill="#91EDEA" cx="241.6" cy="344.8" r="9"/>
      <circle fill="#EFD27F" cx="375.2" cy="172.8" r="9"/>
    </svg>
  `,
